...
def convert_json_to_html(json_data: dict) -> str:
    ...
    html_content: str = convert_bookmarks_to_markdown(bookmarks)
...
def convert_bookmarks_to_markdown(bookmarks: dict) -> str:
    print("Converting bookmarks to Markdown...")
...
def write_md(html_content: str) -> None:
    print("Writing Markdown...")

    current_date: str = datetime.datetime.now().strftime("%Y_%m_%d")
    output_file: Path = Path("arc_bookmarks_" + current_date).with_suffix(".md")
